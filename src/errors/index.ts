...
createErrorFromCodeLookup.set(0x1773, () => new CanNotCallOffReinsuranceError())
createErrorFromNameLookup.set(
...
createErrorFromNameLookup.set('NotEnoughVotes', () => new NotEnoughVotesError())
...
createErrorFromNameLookup.set('RefundDeclined', () => new RefundDeclinedError())
...
createErrorFromCodeLookup.set(0x1786, () => new IncorrectMetadataAccountError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1788, () => new LifeCycleCanNotEndInPastError())
createErrorFromNameLookup.set(
